...
export type ViewerFieldsFragment = { __typename: 'User', id: string, email: string, name: string | null };
...
export type MyWorkspacesQuery = { myWorkspaces: Array<{ __typename: 'WorkspaceMembership', role: Types.WorkspaceRole, workspace: { __typename: 'Workspace', id: string, slug: string, name: string } }> };
...
export type RegisterMutation = { register: { __typename: 'RegisterPayload', user: { __typename: 'User', id: string, email: string, name: string | null } | null, errors: Array<{ __typename: 'ValidationErrorType', field: string, code: string, message: string }> } };
...
export type LoginMutation = { login: { __typename: 'LoginPayload', user: { __typename: 'User', id: string, email: string, name: string | null } | null, errors: Array<{ __typename: 'ValidationErrorType', field: string, code: string, message: string }> } };

export type LogoutMutationVariables = Exact<{ [key: string]: never; }>;


export type LogoutMutation = { logout: { __typename: 'LogoutPayload', signedOut: boolean, errors: Array<{ __typename: 'ValidationErrorType', field: string, code: string, message: string }> } };
...
export const ViewerFieldsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ViewerFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]} as unknown as DocumentNode<ViewerFieldsFragment, unknown>;
